...
import { releasedV0SessionFormatCodec } from '@knyazevai/dsh-session-format-v0-to-v1'
import type { SessionFormatEvent, SessionFormatMigrationContext } from '@knyazevai/dsh-session-format'
...
import { parseSessionLog, prepareSessionSnapshotFixtureForComparison } from '@knyazevai/dsh-llm-replay'
      ...
      const content = [
        ...
        { type: 'system/message', seq: 2, time: 3, data: {
          ...
          message: { role: 'system', content: [{ type: 'text', text: 'fresh system prompt' }],
            source: { kind: 'plugin', plugin: '@knyazevai/dsh-system-prompt' }, id: 'fresh-msg' },
        }, surfaceOp: 'append' },
        {
          type: 'request/header',
          seq: 3,
