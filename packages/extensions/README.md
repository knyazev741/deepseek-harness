...
- [Generated tool catalog](../../docs/tool-catalog.md#knyazevaidsh-tool-cordis) — the seven model-facing tool schemas.
- [Generated configuration catalog](../../docs/config-catalog.md#knyazevaidsh-cordis-host-runner) — the runner's accepted config fields.
