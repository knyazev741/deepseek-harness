...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  },
  {
    ...
    mode: 'emit',
    signature: '\'mcp-gateway/call-started\'(payload: { route: string; callId: string }): void',
    ...
    parameters: [{ name: 'payload', description: 'call ownership payload.' }],
  },
  {
    name: 'mcp-gateway/call-terminal',
    mode: 'emit',
    signature: '\'mcp-gateway/call-terminal\'(payload: { route: string; callId: string }): void',
    summary: 'One gateway call committed a terminal recorder result or teardown error.',
    description: 'One gateway call committed a terminal recorder result or teardown error.',
    parameters: [{ name: 'payload', description: 'call ownership payload.' }],
  },
  {
    name: 'mcp-gateway/lease-created',
    mode: 'emit',
    signature: '\'mcp-gateway/lease-created\'(payload: { route: string }): void',
    ...
    parameters: [{ name: 'payload', description: 'route ownership payload.' }],
  },
  {
    name: 'mcp-gateway/lease-disposed',
    mode: 'emit',
    signature: '\'mcp-gateway/lease-disposed\'(payload: { route: string }): void',
