...
- [生成的工具目录](../../docs/tool-catalog.zh.md#knyazevaidsh-tool-cordis)——七个模型侧工具 schema。
- [生成的配置目录](../../docs/config-catalog.zh.md#knyazevaidsh-cordis-host-runner)——runner 的受支持配置字段。
