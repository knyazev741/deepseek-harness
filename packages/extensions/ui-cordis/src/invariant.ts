/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-cordis`.
 * @module @knyazevai/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-cordis'
