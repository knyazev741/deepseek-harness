/**
 * Package-owned invariant companion for `@knyazevai/dsh-cordis-host-runner`.
 * @module @knyazevai/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-cordis-host-runner'
