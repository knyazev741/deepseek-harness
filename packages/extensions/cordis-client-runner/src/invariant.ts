/**
 * Package-owned invariant companion for `@knyazevai/dsh-cordis-client-runner`.
 * @module @knyazevai/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-cordis-client-runner'
