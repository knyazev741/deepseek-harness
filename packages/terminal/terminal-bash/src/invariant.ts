/**
 * Package-owned invariant companion for `@knyazevai/dsh-terminal-bash`.
 * @module @knyazevai/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-terminal-bash'
