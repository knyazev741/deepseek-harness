/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-terminal`.
 * @module @knyazevai/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-terminal'
