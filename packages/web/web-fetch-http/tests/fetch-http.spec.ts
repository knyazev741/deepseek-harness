...
import { HttpFetchProvider, LOCAL_FETCH_PROVIDER_ID } from '@knyazevai/dsh-web-fetch-http'
import type { HttpFetchLimits, HttpFetchResolver } from '@knyazevai/dsh-web-fetch-http'
import * as fetchPlugin from '@knyazevai/dsh-web-fetch-http'
