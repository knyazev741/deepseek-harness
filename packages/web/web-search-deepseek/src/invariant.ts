/**
 * Package-owned invariant companion for `@knyazevai/dsh-web-search-deepseek`.
 * @module @knyazevai/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-web-search-deepseek'
