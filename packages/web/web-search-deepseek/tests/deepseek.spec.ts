...
import WebRuntime, { WebError } from '@knyazevai/dsh-web'
import {
  DeepSeekSearchProvider,
  DEEPSEEK_PROVIDER_ID,
} from '@knyazevai/dsh-web-search-deepseek'
import * as deepseekPlugin from '@knyazevai/dsh-web-search-deepseek'
import { citationSnippets, mapAnthropicResponse } from '../src/provider.ts'
import type { AnthropicResponse } from '@knyazevai/dsh-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@knyazevai/dsh-web-search-deepseek'
