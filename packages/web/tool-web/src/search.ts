...
import type { GenericCallView, JsonValue, ToolResult, WebSearchResultView, WebSource } from '@knyazevai/dsh-tools'
import type { WebSearchResult, WebSearchSource } from '@knyazevai/dsh-web'
