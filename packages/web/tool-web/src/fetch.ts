...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@knyazevai/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@knyazevai/dsh-web'
 ...
 * `@knyazevai/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@knyazevai/dsh-tool-call-timeout-policy` to enforce.
