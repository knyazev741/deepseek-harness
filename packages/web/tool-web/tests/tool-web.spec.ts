...
import ToolRuntime, { type ToolExecutionResult } from '@knyazevai/dsh-tools'
import WebRuntime from '@knyazevai/dsh-web'
import type { WebSearchProvider, WebSearchResult } from '@knyazevai/dsh-web'
...
} from '@knyazevai/dsh-tool-web'
import type { ContentBlock } from '@knyazevai/dsh-llm'
import type { ToolResult } from '@knyazevai/dsh-tools'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@knyazevai/dsh-web').WebFetchProvider
