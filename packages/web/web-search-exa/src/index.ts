/**
 * `@knyazevai/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@knyazevai/dsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@knyazevai/dsh-web`.
 *
 * @module @knyazevai/dsh-web-search-exa
 */

import type { Context } from '@deepseek-ai/cordis'
import { launchEnvironmentOf } from '@knyazevai/dsh-launch-environment'
import z from '@deepseek-ai/schemastery'
import type {} from '@knyazevai/dsh-web'
import {
  ExaSearchProvider,
