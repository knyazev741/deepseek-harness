...
生成的[配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-web-search-exa)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [生成配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-web-search-exa)——每个受支持配置字段及其源声明。
