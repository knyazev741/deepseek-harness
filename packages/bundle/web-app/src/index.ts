/**
 * @knyazevai/dsh-web-app — the browser-surface bundle's runtime glue plugin
...
import { addHarnessSourceSection, auditStartupEntries } from '@knyazevai/dsh-app-boot'
import type {} from '@knyazevai/dsh-client-connection'
import * as FrontendStatic from '@knyazevai/dsh-host-frontend-static'
import { launchedThroughSsh, launchEnvironmentOf } from '@knyazevai/dsh-launch-environment'
import { scrubbedParentEnv } from '@knyazevai/dsh-subprocess'
import type {} from '@deepseek-ai/cordis-plugin-loader'
import type {} from '@knyazevai/dsh-host-webserver'
import type {} from '@knyazevai/dsh-shell-env'
...
function resolveDistIndex(): string {
  ...
  try {
    return join(dirname(require.resolve('@knyazevai/dsh-web-frontend/package.json')), 'dist', 'index.html')
  } catch {
    /* v8 ignore next 2 -- reachable only when the frontend package is absent from the checkout */
    throw new Error('web-app: @knyazevai/dsh-web-frontend is not resolvable from this composition')
  }
}
