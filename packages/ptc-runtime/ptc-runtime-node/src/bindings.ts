...
import { DUNDER_MEMBER, PORTABLE_RESERVED_WORDS, RESERVED_BINDING_GLOBALS, RESERVED_ERROR_MEMBERS } from '@knyazevai/dsh-ptc-runtime'
import type { PtcBindingNamespace, PtcRunRequest } from '@knyazevai/dsh-ptc-runtime'
