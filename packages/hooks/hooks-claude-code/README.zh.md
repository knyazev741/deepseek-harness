...
生成的[配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-hooks-claude-code)是每个受支持字段的穷尽式真源。
...
- [生成的配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-hooks-claude-code)——每个受支持配置字段及其源声明。
