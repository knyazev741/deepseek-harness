/**
 * Package-owned invariant companion for `@knyazevai/dsh-hooks-claude-code`.
 * @module @knyazevai/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-hooks-claude-code'
