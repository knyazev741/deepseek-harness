...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@knyazevai/dsh-shell'
import { DEFAULT_HOOK_TIMEOUT_MS, runHook } from '@knyazevai/dsh-hook-protocol'
import type { RunHookOptions } from '@knyazevai/dsh-hook-protocol'
