/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-fs-search`.
 * @module @knyazevai/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-fs-search'
