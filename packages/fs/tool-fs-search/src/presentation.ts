 ...
 * model-facing render consumes ({@link module:@knyazevai/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @knyazevai/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@knyazevai/dsh-tool-fs-search/grep} `formatGrepMatches`), so
