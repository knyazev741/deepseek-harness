 ...
 * `@knyazevai/dsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@knyazevai/dsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@knyazevai/dsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @knyazevai/dsh-fs-sandbox
 */

import { Context } from '@deepseek-ai/cordis'
import { LocalFileSystem } from '@knyazevai/dsh-fs-local'
import type { Config as LocalConfig } from '@knyazevai/dsh-fs-local'
import { FsError } from '@knyazevai/dsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@knyazevai/dsh-fs'
import { writableRoots } from '@knyazevai/dsh-sandbox'
