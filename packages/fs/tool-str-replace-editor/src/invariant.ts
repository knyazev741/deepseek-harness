/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-str-replace-editor`.
 * @module @knyazevai/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-str-replace-editor'
