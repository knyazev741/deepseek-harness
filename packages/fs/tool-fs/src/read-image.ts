 ...
 * @module @knyazevai/dsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import { AttachmentError, AttachmentId } from '@knyazevai/dsh-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType } from '@knyazevai/dsh-attachment'
import type { ContentBlock } from '@knyazevai/dsh-llm'
import { defineTool } from '@knyazevai/dsh-tools'
import type { GenericCallView, ToolExecution } from '@knyazevai/dsh-tools'
