...
import ToolRuntime, { type ToolResult } from '@knyazevai/dsh-tools'
import { FileSystem, FsError, FsTargetKey, FsVersion } from '@knyazevai/dsh-fs'
import type {
  FsDirEntry,
  FsEditOutcome,
  FsEditRequest,
...
import { SessionId, SessionLogOffset, SessionSeq } from '@knyazevai/dsh-session'
