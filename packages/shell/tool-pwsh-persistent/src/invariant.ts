/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-pwsh-persistent`.
 * @module @knyazevai/dsh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-pwsh-persistent'
