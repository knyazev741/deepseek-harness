...
export function apply(ctx: Context): void {
  ctx.shellEnv.register({
    ...
    resolve: execution => execution.agent === undefined && execution.principal === undefined
      ? {}
