...
生成的[配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-shell-env)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [生成的配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-shell-env)——每个受支持配置字段及其源声明。
