...
import { seatbeltProfileArgs } from '@knyazevai/dsh-sandbox-local/src/profiles.ts'
 ...
 * confinement is covered by `@knyazevai/dsh-sandbox-local`. Skips off macOS or when
