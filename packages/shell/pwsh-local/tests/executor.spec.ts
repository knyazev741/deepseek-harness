/**
 * Real-process tests for `@knyazevai/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@knyazevai/dsh-pwsh-local'
import LocalSubprocessRuntime from '@knyazevai/dsh-subprocess-local'
import SubprocessRuntime from '@knyazevai/dsh-subprocess'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputReader, SubprocessSpawnSpec } from '@knyazevai/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@knyazevai/dsh-timeout'
import type { ShellProcess } from '@knyazevai/dsh-shell'
