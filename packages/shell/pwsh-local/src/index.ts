 ...
 *
 * @module @knyazevai/dsh-pwsh-local
 */
...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@knyazevai/dsh-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@knyazevai/dsh-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@knyazevai/dsh-subprocess'
import { installSettingsSection } from '@knyazevai/dsh-settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@knyazevai/dsh-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@knyazevai/dsh-pwsh-sandbox`.
