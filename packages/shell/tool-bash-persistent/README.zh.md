...
生成的[配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-tool-bash-persistent)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [生成的工具目录](../../../docs/tool-catalog.zh.md#knyazevaidsh-tool-bash-persistent)——`bash` 参数 schema 的确切内容。
- [生成的配置目录](../../../docs/config-catalog.zh.md#knyazevaidsh-tool-bash-persistent)——每个受支持配置字段及其源声明。
...
生成的 [`bash` schema](../../../docs/tool-catalog.zh.md#knyazevaidsh-tool-bash-persistent)，包括配置的 `description`。本插件不贡献独立的系统提示词区段；人设与环境指引由部署方负责。
