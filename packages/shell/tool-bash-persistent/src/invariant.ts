/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-bash-persistent`.
 * @module @knyazevai/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-bash-persistent'
