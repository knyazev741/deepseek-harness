 ...
 * mirror of `@knyazevai/dsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @knyazevai/dsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@knyazevai/dsh-shell'
import type { RunnerFailureRule } from '@knyazevai/dsh-sandbox'
