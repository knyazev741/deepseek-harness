/**
 * Package-owned invariant companion for `@knyazevai/dsh-pwsh-sandbox`.
 * @module @knyazevai/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-pwsh-sandbox'
