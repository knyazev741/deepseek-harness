 ...
 *
 * @module @knyazevai/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@knyazevai/dsh-shell'
import type { SandboxMode } from '@knyazevai/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@knyazevai/dsh-sandbox'
 ...
 * rendering story, owned by `@knyazevai/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@knyazevai/dsh-shell'
