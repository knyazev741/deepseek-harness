...
The generated [configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-tool-pwsh) is the exhaustive source for every accepted field and its JSDoc; the generated [tool catalog](../../../docs/tool-catalog.md#knyazevaidsh-tool-pwsh) carries the full argument schema.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#knyazevaidsh-tool-pwsh) — the exact `pwsh` argument schema.
- [Generated configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-tool-pwsh) — every accepted config field and its source declaration.
...
The model sees the generated [`pwsh` schema](../../../docs/tool-catalog.md#knyazevaidsh-tool-pwsh). Agent-scoped tool restrictions can remove the definition for that agent.
...
- **No persistent shell** — every call starts a fresh `pwsh -Command`; the persistent-shell counterpart is [`@knyazevai/dsh-tool-pwsh-persistent`](../tool-pwsh-persistent/README.md), which keeps one owner-scoped pwsh alive across calls.
