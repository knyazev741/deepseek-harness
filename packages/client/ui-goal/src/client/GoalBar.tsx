...
import type { GoalSnapshot } from '@knyazevai/dsh-goal/client'
import {
...
export type GoalDockProps = import('@knyazevai/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
