/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-goal`.
 * @module @knyazevai/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-goal'
