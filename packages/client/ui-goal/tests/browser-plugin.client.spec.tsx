...
import { SlotRegistry, type SessionId } from '@knyazevai/dsh-client-runtime/client'
import { ConversationEventRegistry } from '@knyazevai/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@knyazevai/dsh-goal/client'
