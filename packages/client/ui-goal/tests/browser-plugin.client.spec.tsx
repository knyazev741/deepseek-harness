...
import type { GoalActivation, GoalId, GoalProjection, GoalView } from '@knyazevai/dsh-goal/client'
import { LocaleRuntime } from '@knyazevai/dsh-client-locale/client'
import { makeTranslate, RemoteError } from '@knyazevai/dsh-client-test-runtime'
