/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-sidebar`.
 * @module @knyazevai/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-sidebar'
