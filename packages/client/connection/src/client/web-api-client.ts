...
import { hostFrameSchema, muxFrameSchema } from '@knyazevai/dsh-host-apiproxy/api/events.schema'
import { serverRequestSchema } from '@knyazevai/dsh-host-apiproxy/api/rpc.schema'
