/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-connection`.
 * @module @knyazevai/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-connection'
