...
import { apply as nodeApply } from '@knyazevai/dsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@knyazevai/dsh-client-locale/client'
import * as LocaleInvariant from '@knyazevai/dsh-client-locale/invariant'
