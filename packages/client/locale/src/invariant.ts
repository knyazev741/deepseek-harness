/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-locale`.
 * @module @knyazevai/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-locale'
