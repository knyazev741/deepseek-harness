/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-attachment`.
 * @module @knyazevai/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-attachment'
