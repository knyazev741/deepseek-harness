/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-brand-official`.
 * @module @knyazevai/dsh-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-brand-official'
