/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-settings-general`.
 * @module @knyazevai/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-settings-general'
