...
import type { SettingsNamespaceView } from '@knyazevai/dsh-settings/types'
...
import { LOCALE_SETTINGS_NAMESPACE, LocaleSettingsSchema } from '@knyazevai/dsh-client-locale/src/locale-settings.ts'
...
const SELF = '@knyazevai/dsh-client-ui-settings-general'
