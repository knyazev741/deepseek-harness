/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-layout`.
 * @module @knyazevai/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-layout'
