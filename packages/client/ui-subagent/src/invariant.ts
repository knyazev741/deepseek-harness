/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-subagent`.
 * @module @knyazevai/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-subagent'
