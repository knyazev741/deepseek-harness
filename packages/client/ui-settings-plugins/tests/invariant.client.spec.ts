...
import * as PluginConfigInvariant from '@knyazevai/dsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@knyazevai/dsh-client-ui-settings-plugins')
