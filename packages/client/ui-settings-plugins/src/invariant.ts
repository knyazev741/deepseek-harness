/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-settings-plugins`.
 * @module @knyazevai/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-settings-plugins'
