...
import type { IApiClient } from '@knyazevai/dsh-client-connection/client'
import type { SettingsScope, SettingsScopeSnapshot, SnapshotStore } from '@knyazevai/dsh-client-runtime/client'
import {
