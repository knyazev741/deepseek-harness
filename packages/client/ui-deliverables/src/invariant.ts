/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-deliverables`.
 * @module @knyazevai/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-deliverables'
