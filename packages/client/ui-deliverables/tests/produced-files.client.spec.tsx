...
import type { ChatFileMentions, TurnTailOwnerProps } from '@knyazevai/dsh-client-ui-conversation/client'
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@knyazevai/dsh-client-ui-deliverables'])
