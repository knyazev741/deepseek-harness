/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-user-questions`.
 * @module @knyazevai/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-user-questions'
