...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@knyazevai/dsh-client-ui-slots'
import { FileTypeIcon, IconRefreshOutline16, Menu, Tooltip, classifyFileType } from '@knyazevai/dsh-client-ui-primitives'
import { pathPartsOf } from '@knyazevai/dsh-util-workspace-path'
