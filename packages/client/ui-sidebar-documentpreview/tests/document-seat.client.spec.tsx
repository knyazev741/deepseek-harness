...
import { apply as resourcesApply, inject as resourcesInject } from '@knyazevai/dsh-client-resources/src/client/index.ts'
import { apply as sidebarApply, inject as sidebarInject } from '@knyazevai/dsh-client-ui-sidebar-right/src/client/index.ts'
