/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-settings-models`.
 * @module @knyazevai/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-settings-models'
