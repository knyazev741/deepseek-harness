/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-commands`.
 * @module @knyazevai/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-commands'
