...
export const zh = {
  ...
  'section.sessions': '会话',
  'browser.tab.workspaces': '工作区',
  'browser.tab.background': '后台',
  'browser.tabs.aria': '浏览视图',
  ...
  'menu.copySessionIdDone': '已复制会话 ID',
...
export const en = {
  ...
  'browser.tab.workspaces': 'Workspaces',
  'browser.tab.background': 'Background',
  'browser.tabs.aria': 'Browse views',
  ...
  'menu.copySessionIdDone': 'Session ID copied',
