/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-workspace`.
 * @module @knyazevai/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-workspace'
