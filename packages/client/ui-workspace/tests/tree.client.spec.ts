...
import type { SessionPendingInteractionBase } from '@knyazevai/dsh-client-ui-session/client'
import type { ScheduleId, ScheduleRecord } from '@knyazevai/dsh-schedule/client'
