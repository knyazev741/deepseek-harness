...
const SNAPSHOT = {
  entries: [
    ...
    { entryId: 'bash-host', moduleName: '@knyazevai/dsh-tool-bash', enabled: false, fiberPhase: null },
    { entryId: 'fs-host', moduleName: '@knyazevai/dsh-tool-fs', enabled: false, fiberPhase: null },
  ...
  agentPresets: [
    {
      ...
      isDefault: true,
      rows: [
        { entryId: 'bash', moduleName: '@knyazevai/dsh-tool-bash', enabled: true, fiberPhase: 'active' },
        { entryId: 'fs', moduleName: '@knyazevai/dsh-tool-fs', enabled: true, fiberPhase: null },
        {
          entryId: 'pwsh',
    ...
    },
    {
      ...
      isDefault: false,
      rows: [
        { entryId: 'bash', moduleName: '@knyazevai/dsh-tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'bash-fork', moduleName: '@knyazevai/dsh-tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'fs', moduleName: '@knyazevai/dsh-tool-fs', enabled: 'conditional', fiberPhase: null },
      ],
    },
  ...
  it('distinguishes collapsed same-module rows by stable entry id', async () => {
    ...
    await renderReady({
      ...
      agentPresets: [{
        ...
        isDefault: true,
        rows: [
          { entryId: 'tool-subagent-primary', moduleName: '@knyazevai/dsh-tool-subagent', enabled: true, fiberPhase: null },
          { entryId: longId, moduleName: '@knyazevai/dsh-tool-subagent', enabled: false, fiberPhase: null },
        ],
      }],
    })
