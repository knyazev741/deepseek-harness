...
import type { SessionMaybeProvideInfo, StoredEntry } from '@knyazevai/dsh-client-ui-slots'
import type { SessionProvideInfo, SlotRendererHost } from '@knyazevai/dsh-client-ui-renderer/client'
