/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-theme`.
 * @module @knyazevai/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-theme'
