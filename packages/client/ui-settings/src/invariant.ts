/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-settings`.
 * @module @knyazevai/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-settings'
