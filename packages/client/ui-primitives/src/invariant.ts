/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-primitives`.
 * @module @knyazevai/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-primitives'
