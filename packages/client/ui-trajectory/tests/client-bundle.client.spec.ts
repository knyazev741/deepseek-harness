 ...
 * not built (`pnpm --filter @knyazevai/dsh-client-ui-trajectory bundle`).
 */
...
import { UiConversation } from '@knyazevai/dsh-client-ui-conversation/client'
import { SlotRegistry } from '@knyazevai/dsh-client-ui-renderer/client'

const PLUGIN_ID = '@knyazevai/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@knyazevai/dsh-client-store', await import('@knyazevai/dsh-client-store')],
      ['@knyazevai/dsh-client-ui-conversation/client', await import('@knyazevai/dsh-client-ui-conversation/client')],
      ['@knyazevai/dsh-client-ui-primitives', await import('@knyazevai/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@knyazevai/dsh-client-locale/client')
