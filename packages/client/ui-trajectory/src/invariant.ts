/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-trajectory`.
 * @module @knyazevai/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-trajectory'
