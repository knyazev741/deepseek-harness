/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-model-selection`.
 * @module @knyazevai/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-model-selection'
