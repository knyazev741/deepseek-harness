...
import { createScope } from '@knyazevai/dsh-api-session-controller/client'
...
import type { ModelSelection, ModelSelectionProjection } from '@knyazevai/dsh-api-session-controller/types'
import type { CommandContribution, PopupSelectSpec, SelectOption } from '@knyazevai/dsh-client-ui-commands/client'
