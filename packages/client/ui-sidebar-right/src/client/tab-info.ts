...
import { findTabPane } from '@knyazevai/dsh-client-ui-dockkit'
import type { TabId } from '@knyazevai/dsh-client-ui-dockkit'
import type { KeyedSnapshotSelectorHook, PropsStore, SlotHookFactory } from '@knyazevai/dsh-client-ui-slots'
