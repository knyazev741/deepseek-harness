/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-directory-picker-browse`.
 * @module @knyazevai/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-directory-picker-browse'
