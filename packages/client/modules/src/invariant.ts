/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-modules`.
 * @module @knyazevai/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-modules'
