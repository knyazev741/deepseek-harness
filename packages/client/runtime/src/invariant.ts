/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-runtime`.
 * @module @knyazevai/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@knyazevai/dsh-client-ui-slots'
import type { InvariantInstaller } from '@knyazevai/dsh-invariants'

const PACKAGE_NAME = '@knyazevai/dsh-client-runtime'
