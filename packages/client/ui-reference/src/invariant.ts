/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-reference`.
 * @module @knyazevai/dsh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-reference'
