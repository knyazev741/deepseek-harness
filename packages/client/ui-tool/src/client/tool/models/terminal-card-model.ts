...
import type { TerminalBlockLabels, TerminalBlockProps } from '@knyazevai/dsh-client-ui-primitives'
import type { TranslateNS } from '@knyazevai/dsh-client-ui-slots'
import { resolveWorkspacePath } from '@knyazevai/dsh-util-workspace-path'
import { hasSpillNotice } from '@knyazevai/dsh-spill-policy/notice'
...
/**
 * Parse the marker literals owned by `@knyazevai/dsh-shell/render` without
