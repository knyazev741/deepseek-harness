...
import type { OpenFileOptions, ToolCallBlock } from '@knyazevai/dsh-client-ui-chat/client'
import type { MessageImageLoader, MessageImageSource } from '@knyazevai/dsh-client-ui-conversation/client'
