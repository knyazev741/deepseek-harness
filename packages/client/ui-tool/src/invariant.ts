/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-tool`.
 * @module @knyazevai/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-tool'
