...
import type { ISession, SessionId, ToolResultNode } from '@knyazevai/dsh-client-runtime/client'
import type { PropsRenderSlots } from '@knyazevai/dsh-client-ui-slots'
import { SlotTestRuntime, stubSettingsScope } from '@knyazevai/dsh-client-test-runtime'
...
import { apply as applyTool, inject as injectTool } from '@knyazevai/dsh-client-ui-tool/client'
import type { ToolCallViewProps } from '@knyazevai/dsh-client-ui-tool/client'
