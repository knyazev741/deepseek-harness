...
import type { HostDescription } from '@knyazevai/dsh-client-connection/client'
import type {
  ChatConversationViewNode, ChatSnapshot, ConversationNode, RunningToolCall, SessionId,
} from '@knyazevai/dsh-client-runtime/client'
import type { SessionProviderComponent, TranslateNS } from '@knyazevai/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@knyazevai/dsh-client-ui-conversation/src/client/contract/slots.ts'
