/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-slots`.
 * @module @knyazevai/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-slots'
