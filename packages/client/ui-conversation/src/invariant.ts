/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-conversation`.
 * @module @knyazevai/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-conversation'
