...
export const zh = {
  ...
  'message.retry.compactHint': '上下文可能过大导致请求无响应，可运行 /compact 压缩后重试',
...
export const en = {
  ...
  'context.high': 'high context pressure',
  ...
  'message.retry.compactHint': 'A too-large context may be stalling the request. Run /compact to shrink it and retry.',
