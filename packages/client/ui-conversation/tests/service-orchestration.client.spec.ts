...
import { makeTranslate, SlotTestRuntime } from '@knyazevai/dsh-client-test-runtime'
import type { QueuedMessage, SessionFace } from '@knyazevai/dsh-client-runtime/client'
