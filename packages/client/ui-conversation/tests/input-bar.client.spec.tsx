...
import type { ClientContext, ConversationSnapshot, SessionId } from '@knyazevai/dsh-client-runtime/client'
import type { SubmitOutcome } from '@knyazevai/dsh-client-ui-input-trigger/client'
