/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-plan`.
 * @module @knyazevai/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-plan'
