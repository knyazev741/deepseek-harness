 ...
 * @module @knyazevai/dsh-client-ui-message-feedback/client/controller
 */

import type { HostObservable } from '@knyazevai/dsh-client-ui-slots'
import type { ClientRemote, MessageId } from '@knyazevai/dsh-api-remotes/client'
...
} from '@knyazevai/dsh-message-feedback/types'
