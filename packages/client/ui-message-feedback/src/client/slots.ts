 ...
 * @module @knyazevai/dsh-client-ui-message-feedback/client/slots
 */
...
import type { MessageFeedbackItem, MessageFeedbackRating } from '@knyazevai/dsh-message-feedback/types'
