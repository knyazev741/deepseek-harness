 ...
 * @module @knyazevai/dsh-client-ui-message-feedback/client/dialog
 */

import { createSnapshotStore, type SnapshotStore } from '@knyazevai/dsh-client-store'
import type { MessageId } from '@knyazevai/dsh-api-remotes/client'
import type { FeedbackCategory, FeedbackRecord } from '@knyazevai/dsh-command-feedback/types'
import type { MessageFeedbackRating } from '@knyazevai/dsh-message-feedback/types'
