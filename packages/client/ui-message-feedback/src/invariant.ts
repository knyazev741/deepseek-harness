/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-message-feedback`.
 * @module @knyazevai/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-message-feedback'
