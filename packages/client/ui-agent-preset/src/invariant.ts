/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-agent-preset`.
 * @module @knyazevai/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-agent-preset'
