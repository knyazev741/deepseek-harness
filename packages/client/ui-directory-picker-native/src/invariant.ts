/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-directory-picker-native`.
 * @module @knyazevai/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-directory-picker-native'
