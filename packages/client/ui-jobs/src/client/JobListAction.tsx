...
import type { SessionJob as JobView } from '@knyazevai/dsh-api-session-controller/types'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@knyazevai/dsh-client-ui-primitives'
import type { PropsLocale, PropsRuntime, TranslateNS } from '@knyazevai/dsh-client-ui-slots'
