/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-jobs`.
 * @module @knyazevai/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-jobs'
