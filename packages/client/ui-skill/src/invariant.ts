/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-ui-skill`.
 * @module @knyazevai/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-ui-skill'
