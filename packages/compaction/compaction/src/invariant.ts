/** Package-owned compaction log-stream invariants. @module @knyazevai/dsh-compaction/invariant */

import type { Context } from '@deepseek-ai/cordis'
import { isReplacementSurfaceEvent, SessionSeq } from '@knyazevai/dsh-session'
import type { Session, SessionEvent } from '@knyazevai/dsh-session'
import { SurfaceManager } from '@knyazevai/dsh-session/surface'
...
const PACKAGE_NAME = '@knyazevai/dsh-compaction'
