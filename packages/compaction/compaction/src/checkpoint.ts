 ...
 *
 * The seam itself lives in `@knyazevai/dsh-compaction`, which re-exports these
 ...
 *
 * @module @knyazevai/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@knyazevai/dsh-llm/message'
