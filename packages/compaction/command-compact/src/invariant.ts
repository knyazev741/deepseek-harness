/**
 * Package-owned invariant companion for `@knyazevai/dsh-command-compact`.
 * @module @knyazevai/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-command-compact'
