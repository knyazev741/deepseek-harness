...
import * as invariant from '@knyazevai/dsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@knyazevai/dsh-command-compact', expect.any(Function))
    expect(() => {
