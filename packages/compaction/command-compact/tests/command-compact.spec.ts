...
import CommandRuntime, { type CommandResult } from '@knyazevai/dsh-commands'
import {
  CompactionId,
  CompactionEngine,
...
describe('@knyazevai/dsh-command-compact registration', () => {
  it('registers one argument-free command with Loader-safe exports and disposes it', async () => {
    ...
    expect(test.ctx.commands.list(test.agent)).toContainEqual({
      definitionId: '@knyazevai/dsh-command-compact',
      name: 'compact',
