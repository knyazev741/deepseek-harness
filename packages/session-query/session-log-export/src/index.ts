...
import type { CommandDefinitionId } from '@knyazevai/dsh-commands/brand'
import Schema from '@deepseek-ai/schemastery'
import { brandString } from '@knyazevai/dsh-brand'
import type {} from '@knyazevai/dsh-attachment'
import type { CommandResult } from '@knyazevai/dsh-commands'
...
export function apply(ctx: Context, config: Config = {}): void {
  ctx.effect(() => ctx.commands.register({
    definitionId: brandString<CommandDefinitionId>('@knyazevai/dsh-session-log-export'),
    name: 'export',
