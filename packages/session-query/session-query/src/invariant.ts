/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-query`.
 * @module @knyazevai/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-query'
