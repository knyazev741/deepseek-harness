/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-query-sqlite`.
 * @module @knyazevai/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-query-sqlite'
