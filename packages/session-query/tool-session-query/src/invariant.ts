/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-session-query`.
 * @module @knyazevai/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-session-query'
