 ...
 *
 * @module @knyazevai/dsh-tool-session-query/workspace-access
 */
...
import type { TurnBoundaryProjection } from '@knyazevai/dsh-agent'
import type {
  SessionLineageNode,
  SessionRecord,
} from '@knyazevai/dsh-session-query'
import type { ToolRunContext } from '@knyazevai/dsh-tools'
