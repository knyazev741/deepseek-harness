...
function makeRemote(initial: ForkWorkspaceSessionStateView) {
  let view = initial
  ...
  return {
    list,
    setPinned,
    setView(next: ForkWorkspaceSessionStateView) { view = next },
    queueList(result: Promise<{ ok: true; value: ForkWorkspaceSessionStateView }>) { queuedLists.push(result) },
  }
}
...
async function bench(options: {
  ...
  runtime.ctx.provide('workspaceContributions', createContributions())
