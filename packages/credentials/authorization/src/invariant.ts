/**
 * Package-owned invariant companion for `@knyazevai/dsh-authorization`.
 * @module @knyazevai/dsh-authorization/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantFailure, InvariantInstaller } from '@knyazevai/dsh-invariants'

const PACKAGE_NAME = '@knyazevai/dsh-authorization'
