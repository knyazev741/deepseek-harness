 ...
 * @module @knyazevai/dsh-credentials-local
 */
...
import { withFileLock, writeFileAtomic } from '@knyazevai/dsh-atomic-write'
import { canonicalizeWatchPath, resolveDshHome } from '@knyazevai/dsh-home-paths'
import { launchEnvironmentOf } from '@knyazevai/dsh-launch-environment'
import { CredentialProvider, credentialRef, parseCredentialKey } from '@knyazevai/dsh-credentials'
import type {
  ApiKeyRecord,
  CredentialInfo,
  CredentialKey,
...
import type { LaunchEnvironmentEntry } from '@knyazevai/dsh-launch-environment'
