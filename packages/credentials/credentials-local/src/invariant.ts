/**
 * Package-owned invariant companion for `@knyazevai/dsh-credentials-local`.
 * @module @knyazevai/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-credentials-local'
