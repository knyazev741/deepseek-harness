...
import { credentialKey, credentialKeyScope, credentialRef, parseCredentialKey } from '@knyazevai/dsh-credentials'
import type { CredentialKey, CredentialRecord } from '@knyazevai/dsh-credentials'
