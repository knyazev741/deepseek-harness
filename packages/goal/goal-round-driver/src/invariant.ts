/** Package-owned goal-round prompt invariants. @module @knyazevai/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@deepseek-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@knyazevai/dsh-goal'
...
const PACKAGE_NAME = '@knyazevai/dsh-goal-round-driver'
