/**
 * Package-owned invariant companion for `@knyazevai/dsh-command-goal`.
 * @module @knyazevai/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-command-goal'
