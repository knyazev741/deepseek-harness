/** Package-owned session-event invariants for sandbox policy. @module @knyazevai/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@knyazevai/dsh-sandbox-policy'
