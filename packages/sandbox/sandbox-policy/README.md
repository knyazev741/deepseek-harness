...
The generated [configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-sandbox-policy) is the exhaustive source for every accepted field and its JSDoc.
