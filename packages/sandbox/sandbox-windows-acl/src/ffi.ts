...
import { createLazyRequire } from '@knyazevai/dsh-lazy-require'
import {
  ...
  isNullPtr,
  throwLastError,
} from '@knyazevai/dsh-win32-process'
import type { NativePtr, Win32ProcessBindings } from '@knyazevai/dsh-win32-process'
...
export type { NativePtr } from '@knyazevai/dsh-win32-process'
