...
import { Win32Error } from '@knyazevai/dsh-win32-process'
import { ERROR_BROKEN_PIPE } from '@knyazevai/dsh-win32-process/src/abi.ts'
import { processInformationType } from '@knyazevai/dsh-win32-process/src/ffi.ts'
