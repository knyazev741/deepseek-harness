...
import SessionStore, { SessionSeq, type Session, type SessionEvent } from '@knyazevai/dsh-session'
import * as PermissionInvariant from '@knyazevai/dsh-permission-presets/invariant'
