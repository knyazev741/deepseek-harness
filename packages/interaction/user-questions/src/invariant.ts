/**
 * Package-owned invariant companion for `@knyazevai/dsh-user-questions`.
 * @module @knyazevai/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-user-questions'
