/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-ask-user`.
 * @module @knyazevai/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-ask-user'
