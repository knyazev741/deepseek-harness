...
import type { EncodedImageAttachment, FileAttachmentRef, ImageAttachmentRef } from '@knyazevai/dsh-attachment/types'
import type { FileBlock, ImageBlock } from '@knyazevai/dsh-llm'
