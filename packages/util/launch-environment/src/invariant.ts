/**
 * Package-owned invariant companion for `@knyazevai/dsh-launch-environment`.
 * @module @knyazevai/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-launch-environment'
