/**
 * Package-owned invariant companion for `@knyazevai/dsh-native-command`.
 * @module @knyazevai/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-native-command'
