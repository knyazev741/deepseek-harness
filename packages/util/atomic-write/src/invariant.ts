/**
 * Package-owned invariant companion for `@knyazevai/dsh-atomic-write`.
 * @module @knyazevai/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-atomic-write'
