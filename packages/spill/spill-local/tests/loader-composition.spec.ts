...
import LocalSpillStore, { sessionDir } from '@knyazevai/dsh-spill-local'
  ...
  it('loads cleanupPeriodDays and prunes only expired session contents', async () => {
    ...
    context.loader.internal = {
      ...
      async import(specifier: string) {
        if (specifier !== '@knyazevai/dsh-spill-local') throw new Error(`unexpected Loader import: ${specifier}`)
