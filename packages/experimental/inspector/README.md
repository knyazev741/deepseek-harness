...
The generated [configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-experimental-inspector) is the exhaustive source for accepted fields and their declarations.
