...
The generated [configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-tool-todo) is the exhaustive source for the accepted field.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#knyazevaidsh-tool-todo) — the `todo_write` schema the model receives.
- [Generated configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-tool-todo) — every accepted config field and its source declaration.
