/**
 * Package-owned invariant companion for `@knyazevai/dsh-subprocess-e2b`.
 * @module @knyazevai/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-subprocess-e2b'
