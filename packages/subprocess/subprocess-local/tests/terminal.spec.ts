...
import { LocalTerminalHandle } from '@knyazevai/dsh-subprocess-local/src/terminal.ts'
import { createProcessInspector } from '@knyazevai/dsh-subprocess-local/src/process-inspector.ts'
import type {
  ProcessIdentity,
  ProcessInspector,
  ProcessInspectorInternals,
  ProcessSnapshot,
} from '@knyazevai/dsh-subprocess-local/src/process-inspector.ts'
import type { BoundProcessOwner } from '@knyazevai/dsh-subprocess-local/src/managed-owner.ts'
import type { SubprocessTerminalSignal } from '@knyazevai/dsh-subprocess'
