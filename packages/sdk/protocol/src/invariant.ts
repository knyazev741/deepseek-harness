/**
 * Package-owned invariant companion for `@knyazevai/dsh-sdk-protocol`.
 * @module @knyazevai/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-sdk-protocol'
