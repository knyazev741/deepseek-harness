/**
 * Package-owned invariant companion for `@knyazevai/dsh-sdk-jsonrpc-server`.
 * @module @knyazevai/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-sdk-jsonrpc-server'
