 ...
 *
 * @module @knyazevai/dsh-sdk-client/types
 */

import type { ContentBlock, ReasoningEffortId } from '@knyazevai/dsh-llm'
import type { SdkPromptContentBlock } from '@knyazevai/dsh-sdk-protocol'
...
export interface HarnessClientOptions {
   ...
   * credential policy (see `scrubbedParentEnv` in `@knyazevai/dsh-subprocess`
