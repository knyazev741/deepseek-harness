 ...
 * companion beside `@knyazevai/dsh-invariants` to enable the checks.
 *
 * @module @knyazevai/dsh-session/invariant
 */
...
import type { Session, SessionEvent, SessionSeqCursor } from '@knyazevai/dsh-session'
import { assertNever } from '@knyazevai/dsh-util-values'
import { TOOL_NOT_STARTED } from './repair.ts'

const PACKAGE_NAME = '@knyazevai/dsh-session'
