 ...
 * @module @knyazevai/dsh-agent-loop/runtime-context
 */

import { createSystemMessage, createUserMessage } from '@knyazevai/dsh-llm'
import type { ContextSnapshotSection, Message } from '@knyazevai/dsh-llm'
import type { Session, SessionEvent, SessionSeq, SurfaceIntent, SystemMessage, UserMessage } from '@knyazevai/dsh-session'
import { isReplacementSurfaceEvent } from '@knyazevai/dsh-session'
import type { Context } from '@deepseek-ai/cordis'

const SOURCE = '@knyazevai/dsh-system-prompt'
