...
import { emitAgentEvent } from '@knyazevai/dsh-agent'
import type {
  Agent,
  AgentFactory,
  AgentHandle,
...
import { SessionId, SessionPreparation } from '@knyazevai/dsh-session'
import type { Session, SessionHeader } from '@knyazevai/dsh-session'
