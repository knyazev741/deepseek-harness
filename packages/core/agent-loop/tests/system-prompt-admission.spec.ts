...
import AgentRegistry, { installModelSelection, type Agent, type ModelSelectionRef } from '@knyazevai/dsh-agent'
import AgentLoop from '@knyazevai/dsh-agent-loop'
import LlmRuntime, { createUserMessage, LlmError, type GenerateOptions } from '@knyazevai/dsh-llm'
import { toPiContext } from '@knyazevai/dsh-llm-pi-ai/src/context.ts'
