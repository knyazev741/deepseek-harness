...
import { createScope, scopeOf } from '@knyazevai/dsh-scope'
import type { Scope, ScopeKey } from '@knyazevai/dsh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@knyazevai/dsh-system-prompt'
import type { Config, PromptAssembly } from '@knyazevai/dsh-system-prompt'
