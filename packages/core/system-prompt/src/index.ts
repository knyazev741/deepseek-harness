 ...
 *
 * @module @knyazevai/dsh-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@knyazevai/dsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@knyazevai/dsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@knyazevai/dsh-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@knyazevai/dsh-scope`): scoped listeners
