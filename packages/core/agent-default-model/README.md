...
- [Generated configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-agent-default-model) — every accepted config field and its source declaration.
