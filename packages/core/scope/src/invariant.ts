/** Package-owned scoped-dispatch invariants. @module @knyazevai/dsh-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@knyazevai/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@knyazevai/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@knyazevai/dsh-scope'
