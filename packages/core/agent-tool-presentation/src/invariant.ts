/**
 * Package-owned invariant companion for `@knyazevai/dsh-agent-tool-presentation`.
 * @module @knyazevai/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-agent-tool-presentation'
