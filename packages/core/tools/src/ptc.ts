 ...
 * @module @knyazevai/dsh-tools/src/ptc
 */

import { brandString } from '@knyazevai/dsh-brand'
import { createUserMessage, HarnessError } from '@knyazevai/dsh-llm'
import type { ContentBlock, ToolCallId, ToolSchema } from '@knyazevai/dsh-llm'
import type { PtcBindingFunction, PtcRunResult, PtcRunSandbox, PtcRuntime } from '@knyazevai/dsh-ptc-runtime'
import { approveEscalation, ESCALATION_TARGETS, validateEscalationArgs } from '@knyazevai/dsh-sandbox'
import type { SandboxExecutionPolicy } from '@knyazevai/dsh-sandbox'
import type { ApprovalService } from '@knyazevai/dsh-user-approval'
import { deepFreeze, snapshotJsonValue, type JsonValue } from '@knyazevai/dsh-util-values'
