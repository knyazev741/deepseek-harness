/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-subagent-report`.
 * @module @knyazevai/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-subagent-report'
