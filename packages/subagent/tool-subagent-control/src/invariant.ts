/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-subagent-control`.
 * @module @knyazevai/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-subagent-control'
