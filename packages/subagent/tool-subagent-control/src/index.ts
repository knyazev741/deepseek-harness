 ...
 * `@knyazevai/dsh-tool-subagent` instances so multiple delegation tools share
 * one control API.
 * @module @knyazevai/dsh-tool-subagent-control
 */
...
import { markAdjacentAgentSendMessageTool } from '@knyazevai/dsh-subagent/internal'
