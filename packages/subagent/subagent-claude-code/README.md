...
- [Generated configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-subagent-claude-code) — every accepted config field and its source declaration.
