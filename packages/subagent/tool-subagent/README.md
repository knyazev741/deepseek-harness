...
| `modelSelectionDiscovery` | `true` | Own `list_subagent_models`; set `false` on additional selectable delegation tools in the same scope |
...
The generated [configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-tool-subagent) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#knyazevaidsh-tool-subagent) — the default schema and per-mode wording.
- [Generated configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-tool-subagent) — every accepted config field.
