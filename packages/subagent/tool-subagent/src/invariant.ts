/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-subagent`.
 * @module @knyazevai/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-subagent'
