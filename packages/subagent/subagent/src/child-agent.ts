 ...
 *
 * @module @knyazevai/dsh-subagent/child-agent
 */

import type { Context } from '@deepseek-ai/cordis'
import type { Agent, AgentOptions, CreateAgentOptions } from '@knyazevai/dsh-agent'
...
import type { ToolRestriction } from '@knyazevai/dsh-tools'
