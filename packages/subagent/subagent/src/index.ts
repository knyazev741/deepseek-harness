 ...
 * (`@knyazevai/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@knyazevai/dsh-tool-subagent`) are separate packages.
 *
...
import type {} from '@knyazevai/dsh-attachment'
...
import type { ContentBlock, MessageId, MessageSource } from '@knyazevai/dsh-llm'
