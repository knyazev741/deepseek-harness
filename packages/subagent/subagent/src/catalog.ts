 ...
 *
 * @module @knyazevai/dsh-subagent/catalog
 */

import { z } from 'zod'
import { appendChunkedList, chunkedListSchema, iterateChunkedList } from '@knyazevai/dsh-chunked-list'
import type { ChunkedList } from '@knyazevai/dsh-chunked-list'
import type {
  Session,
  SessionEvent,
  SessionHeader,
