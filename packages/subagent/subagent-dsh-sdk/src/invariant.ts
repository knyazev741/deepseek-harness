/**
 * Package-owned invariant companion for `@knyazevai/dsh-subagent-dsh-sdk`.
 * @module @knyazevai/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-subagent-dsh-sdk'
