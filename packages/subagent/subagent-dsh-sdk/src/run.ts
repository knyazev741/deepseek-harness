 ...
 * runtime over stdio JSON-RPC through `@knyazevai/dsh-sdk-client` and owns
 ...
 *
 * @module @knyazevai/dsh-subagent-dsh-sdk/run
 */
...
import type { ContentBlock, ReasoningEffortId } from '@knyazevai/dsh-llm'
import type { SessionEvent, SessionId, TurnEndReason } from '@knyazevai/dsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@knyazevai/dsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@knyazevai/dsh-subagent'
