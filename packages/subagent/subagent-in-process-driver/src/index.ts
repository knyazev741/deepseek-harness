 ...
 * one result.
 *
 * @module @knyazevai/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@deepseek-ai/cordis'
import { brandString } from '@knyazevai/dsh-brand'
import { foldConsumedWork } from '@knyazevai/dsh-agent'
import type { Agent, AgentHandle } from '@knyazevai/dsh-agent'
import { SessionLogOffset } from '@knyazevai/dsh-session'
import type { SessionEvent, SessionId, SessionLogOffset as SessionLogOffsetType, TurnEndReason } from '@knyazevai/dsh-session'
import { createUserMessage, type ContentBlock } from '@knyazevai/dsh-llm'
import {
