/**
 * Package-owned invariant companion for `@knyazevai/dsh-subagent-codex`.
 * @module @knyazevai/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-subagent-codex'
