 ...
 *
 * @module @knyazevai/dsh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@knyazevai/dsh-llm'
import type { SubagentResult } from '@knyazevai/dsh-subagent'
import { JsonRpcLineTransport } from '@knyazevai/dsh-sdk-protocol'
