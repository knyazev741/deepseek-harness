...
The generated [configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-tool-skill) is the exhaustive source for every accepted field.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#knyazevaidsh-tool-skill) — the exact `skill` schema the model receives.
...
The model sees the generated [`skill` schema](../../../docs/tool-catalog.md#knyazevaidsh-tool-skill).
