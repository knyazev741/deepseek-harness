 ...
 * Concrete
 * providers such as `@knyazevai/dsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @knyazevai/dsh-skill
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { assertNever } from '@knyazevai/dsh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@knyazevai/dsh-scope'
