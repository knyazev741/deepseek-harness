/**
 * Package-owned invariant companion for `@knyazevai/dsh-typert-registry`.
 * @module @knyazevai/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-typert-registry'
