/**
 * Package-owned invariant companion for `@knyazevai/dsh-typert-protocol`.
 * @module @knyazevai/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-typert-protocol'
