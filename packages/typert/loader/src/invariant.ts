/**
 * Package-owned invariant companion for `@knyazevai/dsh-typert-loader`.
 * @module @knyazevai/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-typert-loader'
