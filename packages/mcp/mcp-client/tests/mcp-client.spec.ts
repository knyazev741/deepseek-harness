...
import AttachmentStore, { AttachmentError, AttachmentId } from '@knyazevai/dsh-attachment'
...
import { CallId, LlmAdapter, LlmRuntime } from '@knyazevai/dsh-llm'
...
import ToolRuntime, { type JsonValue } from '@knyazevai/dsh-tools'
import type { PostToolDecision } from '@knyazevai/dsh-tools'
import { publicToolName, syncTools, type ToolBridgeOptions } from '@knyazevai/dsh-mcp-client/src/tools.ts'
import { createTransport } from '@knyazevai/dsh-mcp-client/src/transport.ts'
