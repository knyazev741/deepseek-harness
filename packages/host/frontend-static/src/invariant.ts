/**
 * Package-owned invariant companion for `@knyazevai/dsh-host-frontend-static`.
 * @module @knyazevai/dsh-host-frontend-static/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@knyazevai/dsh-invariants'

const PACKAGE_NAME = '@knyazevai/dsh-host-frontend-static'
