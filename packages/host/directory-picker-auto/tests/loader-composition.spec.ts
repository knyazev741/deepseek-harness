...
import HttpServer from '@knyazevai/dsh-host-webserver'
import type { DirectoryPicker } from '@knyazevai/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@knyazevai/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@knyazevai/dsh-host-directory-picker-native'
import {
  createLaunchEnvironmentSnapshot, DSH_LAUNCH_ENVIRONMENT_KEY, type LaunchEnvironmentSnapshot,
} from '@knyazevai/dsh-launch-environment'
...
const AUTO = '@knyazevai/dsh-host-directory-picker-auto'
const NATIVE = '@knyazevai/dsh-host-directory-picker-native'
const BROWSE = '@knyazevai/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@knyazevai/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@knyazevai/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@knyazevai/dsh-host-webserver', HttpServer],
