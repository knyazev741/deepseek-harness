 ...
 * @module @knyazevai/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@knyazevai/dsh-host-directory-picker-native',
  browse: '@knyazevai/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@knyazevai/dsh-client-ui-directory-picker-native',
  browse: '@knyazevai/dsh-client-ui-directory-picker-browse',
}
