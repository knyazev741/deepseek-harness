...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('invalid-mode'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('external-session'), message: z.string(), details: z.object({ sessionId: z.string(), mode: z.string() }) }),
  z.object({ code: z.literal('external-images-unsupported'), message: z.string(), details: z.object({ mode: z.string() }) }),
  z.object({ code: z.literal('external-steer-unsupported'), message: z.string(), details: z.object({ mode: z.string() }) }),
  z.object({ code: z.literal('external-queue-unsupported'), message: z.string(), details: z.object({ mode: z.string().optional(), itemId: z.string().optional(), action: z.string().optional() }) }),
  z.object({ code: z.literal('external-goals-unsupported'), message: z.string(), details: z.object({ command: z.string() }) }),
  z.object({ code: z.literal('external-command-failed'), message: z.string(), details: z.object({ sessionId: z.string(), line: z.string() }) }),
