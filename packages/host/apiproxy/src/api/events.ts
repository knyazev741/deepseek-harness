...
import type { AskUserQuestionItem } from '@knyazevai/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@knyazevai/dsh-user-approval/types'
import type { Message } from '@knyazevai/dsh-llm/types'
import type { MessageId } from '@knyazevai/dsh-llm/brand'
import type { CallId } from '@knyazevai/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@knyazevai/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@knyazevai/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@knyazevai/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
