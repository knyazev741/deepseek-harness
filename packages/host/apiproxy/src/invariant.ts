/**
 * Package-owned invariant companion for `@knyazevai/dsh-host-apiproxy`.
 * @module @knyazevai/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-host-apiproxy'
