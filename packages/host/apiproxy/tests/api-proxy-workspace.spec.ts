...
import AgentRegistry, { Inbox } from '@knyazevai/dsh-agent'
...
import type { DirectoryPickerCapability } from '@knyazevai/dsh-host-directory-picker'
import WorkspaceRegistry from '@knyazevai/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@knyazevai/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@knyazevai/dsh-host-apiproxy/api/rpc'
import { RpcId } from '@knyazevai/dsh-host-apiproxy/api/rpc'
