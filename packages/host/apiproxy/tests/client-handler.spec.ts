...
import type { ApiProxy, GoalRef, HostFrame, MuxFrame, RpcMessage, RpcRequest, RpcResponse } from '@knyazevai/dsh-host-apiproxy'
import { InProcessApiClient, RpcId, toFetchHandler } from '@knyazevai/dsh-host-apiproxy'
