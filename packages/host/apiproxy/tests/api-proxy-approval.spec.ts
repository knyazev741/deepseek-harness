...
import type { ApprovalRequestId } from '@knyazevai/dsh-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@knyazevai/dsh-host-apiproxy/api'
import type { RpcId } from '@knyazevai/dsh-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@knyazevai/dsh-host-apiproxy/api/rpc'
