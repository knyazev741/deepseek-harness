/**
 * Package-owned invariant companion for `@knyazevai/dsh-host-webserver`.
 * @module @knyazevai/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-host-webserver'
