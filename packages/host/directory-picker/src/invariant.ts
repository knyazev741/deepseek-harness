/** Package-owned invariant companion for the directory-picker seam. @module @knyazevai/dsh-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@knyazevai/dsh-invariants'

const PACKAGE_NAME = '@knyazevai/dsh-host-directory-picker'
