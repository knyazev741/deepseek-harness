...
import { createScope, type ScopeKey } from '@knyazevai/dsh-scope'
import { describe, expect, it } from 'vitest'
import * as Persona from '@knyazevai/dsh-persona'
import { PERSONA_SUFFIX_SECTION, PERSONA_PREFIX_SECTION } from '@knyazevai/dsh-persona'
