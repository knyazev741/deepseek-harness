...
import AgentRegistry, { assembleContextFor } from '@knyazevai/dsh-agent'
import AgentLoop from '@knyazevai/dsh-agent-loop'
import InvariantRegistry from '@knyazevai/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@knyazevai/dsh-agent-presets'
import * as AgentPresetsInvariant from '@knyazevai/dsh-agent-presets/invariant'
