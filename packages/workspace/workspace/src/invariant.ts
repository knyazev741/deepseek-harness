/**
 * Package-owned invariant companion for `@knyazevai/dsh-workspace`.
 * @module @knyazevai/dsh-workspace/invariant
 */
...
import { WorkspaceId } from '@knyazevai/dsh-workspace'

const PACKAGE_NAME = '@knyazevai/dsh-workspace'
