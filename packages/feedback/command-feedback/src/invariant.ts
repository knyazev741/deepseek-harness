/**
 * Package-owned invariant companion for `@knyazevai/dsh-command-feedback`.
 * @module @knyazevai/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-command-feedback'
