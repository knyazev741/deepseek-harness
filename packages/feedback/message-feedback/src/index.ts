 ...
 * @module @knyazevai/dsh-message-feedback
 */
...
import { deriveEventMessage, isAppendSurfaceEvent } from '@knyazevai/dsh-session/surface'
import type { SessionHeader, SessionId } from '@knyazevai/dsh-session/types'
