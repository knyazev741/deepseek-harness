/** JSON string-prefix accounting for the outer-output ledger. @module @knyazevai/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@knyazevai/dsh-code-runtime'
