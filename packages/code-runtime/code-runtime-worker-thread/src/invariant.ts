/**
 * Package-owned invariant companion for `@knyazevai/dsh-code-runtime-worker-thread`.
 * @module @knyazevai/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-code-runtime-worker-thread'
