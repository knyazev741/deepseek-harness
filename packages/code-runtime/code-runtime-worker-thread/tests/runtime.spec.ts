...
import type { Config } from '@knyazevai/dsh-code-runtime-worker-thread'
import type { CodeBindingFunction, CodeBindingNamespace, CodeRunResult } from '@knyazevai/dsh-code-runtime'
