/**
 * Package-owned invariant companion for `@knyazevai/dsh-code-runtime-python`.
 * @module @knyazevai/dsh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-code-runtime-python'
