 ...
 *
 * @module @knyazevai/dsh-file-reference-local
 */
...
} from '@knyazevai/dsh-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@knyazevai/dsh-file-reference'
export { activeAtToken, formatFileMention } from '@knyazevai/dsh-file-reference/grammar'
