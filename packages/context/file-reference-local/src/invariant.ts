/**
 * Package-owned invariant companion for `@knyazevai/dsh-file-reference-local`.
 * @module @knyazevai/dsh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-file-reference-local'
