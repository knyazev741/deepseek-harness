/**
 * Package-owned invariant companion for `@knyazevai/dsh-file-reference`.
 * @module @knyazevai/dsh-file-reference/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-file-reference'
