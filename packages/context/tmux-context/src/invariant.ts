/**
 * Package-owned invariant companion for `@knyazevai/dsh-tmux-context`.
 * @module @knyazevai/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tmux-context'
