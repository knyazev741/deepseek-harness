/**
 * Package-owned invariant companion for `@knyazevai/dsh-agent-instructions`.
 * @module @knyazevai/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-agent-instructions'
