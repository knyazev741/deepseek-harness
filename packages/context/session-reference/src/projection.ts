...
import { isCompactCheckpointSource } from '@knyazevai/dsh-compaction'
import type { SessionSurfaceSnapshot } from '@knyazevai/dsh-session-query'
...
import type { OptionalSessionSeq, SessionId } from '@knyazevai/dsh-session'
