/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-reference`.
 * @module @knyazevai/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-reference'
