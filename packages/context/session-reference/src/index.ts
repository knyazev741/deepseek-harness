...
import { createUserMessage, freezeMessage } from '@knyazevai/dsh-llm'
import type { ContentBlock, UserMessage } from '@knyazevai/dsh-llm'
import type { SessionId } from '@knyazevai/dsh-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@knyazevai/dsh-session-query'
import {
