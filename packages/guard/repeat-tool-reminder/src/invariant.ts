/**
 * Package-owned invariant companion for `@knyazevai/dsh-repeat-tool-reminder`.
 * @module @knyazevai/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-repeat-tool-reminder'
