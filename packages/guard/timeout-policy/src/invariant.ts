/**
 * Package-owned invariant companion for `@knyazevai/dsh-tool-call-timeout-policy`.
 * @module @knyazevai/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-tool-call-timeout-policy'
