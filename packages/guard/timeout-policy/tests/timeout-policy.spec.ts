/**
 * Unit + real-load-path coverage for @knyazevai/dsh-tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@knyazevai/dsh-llm'
import SystemPrompt from '@knyazevai/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@knyazevai/dsh-tools'
import * as timeoutPolicy from '@knyazevai/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@knyazevai/dsh-tool-call-timeout-policy'
