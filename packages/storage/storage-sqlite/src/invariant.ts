/**
 * Package-owned invariant companion for `@knyazevai/dsh-storage-sqlite`.
 * @module @knyazevai/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-storage-sqlite'
