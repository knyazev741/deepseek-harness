/**
 * Package-owned invariant companion for `@knyazevai/dsh-storage-json`.
 * @module @knyazevai/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-storage-json'
