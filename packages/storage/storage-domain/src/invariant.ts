/**
 * Package-owned invariant companion for `@knyazevai/dsh-storage-domain`: every
 ...
 * @module @knyazevai/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-storage-domain'
