...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@knyazevai/dsh-authorization'
import { isCredentialKeySegment } from '@knyazevai/dsh-credentials'
