/** Package-owned durable retry-event invariants. @module @knyazevai/dsh-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@knyazevai/dsh-session'
import type { LlmFailure } from '@knyazevai/dsh-llm'
...
const PACKAGE_NAME = '@knyazevai/dsh-llm-retry'
