/**
 * Package-owned invariant companion for `@knyazevai/dsh-client-test-runtime`.
 * @module @knyazevai/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-client-test-runtime'
