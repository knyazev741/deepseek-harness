 ...
 * repository.
 * @module @knyazevai/dsh-client-test-runtime/src/assembly/bundle-roster
 */
...
import { exactPackageSpecifier, parseDshClient } from '@knyazevai/dsh-client-modules/client'
...
export const WEB_PROFILE_BUNDLES: readonly string[] = ['@knyazevai/dsh-base', '@knyazevai/dsh-web-app']
