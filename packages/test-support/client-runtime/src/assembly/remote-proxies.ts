 ...
 * @module @knyazevai/dsh-client-test-runtime/src/assembly/remote-proxies
 */
import type { Context } from '@deepseek-ai/cordis'
import { cancelledFailure, carrierFailure } from '@knyazevai/dsh-api-gateway/client'
...
export const REMOTES_PACKAGE = '@knyazevai/dsh-api-remotes'
