...
import { createClientModuleSystem, parseBootManifest, type ClientBundleRegistration, type ClientModuleLoaderTarget } from '@knyazevai/dsh-client-modules/client'
...
describe('ClientRoster', () => {
  ...
  it('closure treats the platform seed modules as satisfied without a row', () => {
    const seeded = { name: 'seeded', inject: ['@knyazevai/dsh-client-ui-primitives', 'react', 'a'], immediately: false }
