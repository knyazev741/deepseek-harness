...
const test = createClientTest({ roster: webApp.closure(['@knyazevai/dsh-api-gateway']) })
...
const missingConnection = createClientTest({ roster: webApp.pick(['@knyazevai/dsh-typert-registry']) })
