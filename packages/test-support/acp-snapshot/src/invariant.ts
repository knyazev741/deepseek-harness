/**
 * Package-owned invariant companion for `@knyazevai/dsh-acp-snapshot`.
 * @module @knyazevai/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-acp-snapshot'
