/**
 * Package-owned invariant companion for `@knyazevai/dsh-agent-loop-testkit`.
 * @module @knyazevai/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-agent-loop-testkit'
