/**
 * Package-owned invariant companion for `@knyazevai/dsh-llm-mock-server`.
 * @module @knyazevai/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-llm-mock-server'
