 ...
 * zero-build dev path, resolving `@knyazevai/dsh-*` / `@cordisjs/*` through the tsconfig `paths`
 ...
 *
 * @module @knyazevai/dsh-loader-smoke
 */

import { clearedProxyEnv } from '@knyazevai/dsh-http-proxy'
