/**
 * Package-owned invariant companion for `@knyazevai/dsh-loader-smoke`.
 * @module @knyazevai/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-loader-smoke'
