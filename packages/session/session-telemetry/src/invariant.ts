/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-telemetry`.
 * @module @knyazevai/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-telemetry'
