/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-checkpoint-policy`.
 * @module @knyazevai/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-checkpoint-policy'
