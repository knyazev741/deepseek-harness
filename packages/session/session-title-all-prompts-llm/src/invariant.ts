/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-title-all-prompts-llm`.
 * @module @knyazevai/dsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-title-all-prompts-llm'
