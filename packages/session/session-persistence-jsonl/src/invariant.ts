/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-persistence-jsonl`.
 * @module @knyazevai/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-persistence-jsonl'
