/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-projection-cache`.
 * @module @knyazevai/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-projection-cache'
