 ...
 * @module @knyazevai/dsh-session-projection-cache
 */
...
import type { ProjectionCheckpoint, ProjectionSnapshot } from '@knyazevai/dsh-session-projection'
import type { KvTable } from '@knyazevai/dsh-storage-domain'
