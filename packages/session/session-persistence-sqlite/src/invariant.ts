/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-persistence-sqlite`.
 * @module @knyazevai/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-persistence-sqlite'
