/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-projection`.
 * @module @knyazevai/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-projection'
