/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-title-llm`.
 * @module @knyazevai/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-title-llm'
