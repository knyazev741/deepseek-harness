/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-stats`.
 * @module @knyazevai/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-stats'
