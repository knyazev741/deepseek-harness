 ...
 * @module @knyazevai/dsh-session-persistence
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { SessionPreparation } from '@knyazevai/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@knyazevai/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@knyazevai/dsh-session'
