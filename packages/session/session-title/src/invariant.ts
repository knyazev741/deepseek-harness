/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-title`.
 * @module @knyazevai/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-title'
