/**
 * Package-owned invariant companion for `@knyazevai/dsh-session-telemetry-otel`.
 * @module @knyazevai/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-session-telemetry-otel'
