...
- [Generated configuration catalog](../../../docs/config-catalog.md#knyazevaidsh-session-telemetry-otel) — every accepted config field and its source declaration.
