import { AssistantStreamAccumulator } from '@knyazevai/dsh-llm'
...
import {
  HISTORICAL_V0_EVENT_DISPOSITIONS as RELEASED_V0_EVENT_DISPOSITIONS,
  assertReleasedEventPayload,
  assertReleasedV1Header,
  isReleasedAssistantChunkRun,
} from '@knyazevai/dsh-session-format-v0-to-v1'
...
export const sessionFormatV1ToV2 = defineSessionFormatMigration({
  name: '@knyazevai/dsh-session-format-v1-to-v2',
  fromVersion: 1,
  toVersion: 2,
