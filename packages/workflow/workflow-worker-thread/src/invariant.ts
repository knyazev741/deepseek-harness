/**
 * Package-owned invariant companion for `@knyazevai/dsh-workflow-worker-thread`.
 * @module @knyazevai/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-workflow-worker-thread'
