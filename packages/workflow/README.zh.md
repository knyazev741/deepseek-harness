...
- [生成的工具目录](../../docs/tool-catalog.zh.md#knyazevaidsh-tool-workflow)——模型接收的 `workflow` 工具 schema。
- [生成的工具目录](../../docs/tool-catalog.zh.md#knyazevaidsh-tool-ralph)——模型接收的 `ralph` 工具 schema。
- [生成的配置目录](../../docs/config-catalog.zh.md#knyazevaidsh-workflow-ptc)——每个受支持的引擎配置字段。
