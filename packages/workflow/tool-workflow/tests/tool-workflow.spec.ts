...
import type { ToolExecutionResult, ToolExecutionToken } from '@knyazevai/dsh-tools'
...
import WorkerThreadWorkflowEngine from '@knyazevai/dsh-workflow-worker-thread'
