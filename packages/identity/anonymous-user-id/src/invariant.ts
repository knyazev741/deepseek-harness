/**
 * Package-owned invariant companion for `@knyazevai/dsh-anonymous-user-id`.
 * @module @knyazevai/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-anonymous-user-id'
