/**
 * Package-owned invariant companion for `@knyazevai/dsh-agent-spine-demo`.
 * @module @knyazevai/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-agent-spine-demo'
