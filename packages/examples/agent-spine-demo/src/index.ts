 ...
 * @module @knyazevai/dsh-agent-spine-demo
 */
...
import SessionTitleService, { type Config as SessionTitleConfig } from '@knyazevai/dsh-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@knyazevai/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@knyazevai/dsh-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@knyazevai/dsh-skill'
import * as SkillFileSystem from '@knyazevai/dsh-skill-filesystem'
import AgentRegistry from '@knyazevai/dsh-agent'
import GoalService, { type Config as GoalDomainConfig } from '@knyazevai/dsh-goal'
import * as goalSession from '@knyazevai/dsh-goal-round-driver'
import * as toolGoal from '@knyazevai/dsh-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@knyazevai/dsh-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@knyazevai/dsh-invariants'
...
import * as scopeInvariant from '@knyazevai/dsh-scope/invariant'
import * as agentLoopInvariant from '@knyazevai/dsh-agent-loop/invariant'
import * as toolBash from '@knyazevai/dsh-tool-bash'
import * as bashEnv from '@knyazevai/dsh-shell-env'
import * as workspaceContext from '@knyazevai/dsh-agent-instructions'
import * as toolSkill from '@knyazevai/dsh-tool-skill'
import * as toolJobs from '@knyazevai/dsh-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@knyazevai/dsh-agent-loop'
import * as llmRetry from '@knyazevai/dsh-llm-retry'
