/**
 * Package-owned invariant companion for `@knyazevai/dsh-sdk-jsonrpc-demo`.
 * @module @knyazevai/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@knyazevai/dsh-sdk-jsonrpc-demo'
