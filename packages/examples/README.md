...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@knyazevai/dsh-agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@knyazevai/dsh-acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@knyazevai/dsh-sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
