 ...
 * ({@link @knyazevai/dsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @knyazevai/dsh-acp} bridge. The app owns those plugins through one
 ...
 * @module @knyazevai/dsh-acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from '@knyazevai/dsh-acp'
import * as agentCore from '@knyazevai/dsh-agent-spine-demo'
...
} from '@knyazevai/dsh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@knyazevai/dsh-session-checkpoint-policy'
