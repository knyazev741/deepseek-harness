...
import { createUserMessage, LlmAdapter } from '@knyazevai/dsh-llm'
...
assertBuiltBenchmarkRuntime(import.meta.url, Object.fromEntries([
  '@knyazevai/dsh-agent-loop', '@knyazevai/dsh-session', '@knyazevai/dsh-llm',
  '@knyazevai/dsh-tools', '@knyazevai/dsh-session-persistence-jsonl',
