...
import type { ChatSnapshot } from '@knyazevai/dsh-client-ui-chat/client'
import type { SessionEventLikeEntry } from '@knyazevai/dsh-api-session-controller/client'
...
assertBuiltBenchmarkRuntime(import.meta.url, {
  '@knyazevai/dsh-client-store': import.meta.resolve('@knyazevai/dsh-client-store'),
  '@knyazevai/dsh-llm/assistant-stream': import.meta.resolve('@knyazevai/dsh-llm/assistant-stream'),
  '@knyazevai/dsh-session/surface': import.meta.resolve('@knyazevai/dsh-session/surface'),
  '@knyazevai/dsh-token-meter/client': import.meta.resolve('@knyazevai/dsh-token-meter/client'),
})
