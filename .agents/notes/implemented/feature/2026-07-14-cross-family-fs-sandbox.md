...
`packages/sandbox/sandbox-policy/` (`@knyazevai/dsh-sandbox-policy`) registers `ctx.sandboxPolicy`, the single owner of the deployment's sandbox policy:
