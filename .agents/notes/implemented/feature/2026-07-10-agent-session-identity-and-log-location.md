...
- `DSH_HOME` is always the absolute configured Harness home. The standalone [`@knyazevai/dsh-home-paths`](../../../../packages/util/home-paths/README.md) utility owns its precedence: explicit `dshHome`, then ambient `$DSH_HOME`, then `~/.dsh`.
