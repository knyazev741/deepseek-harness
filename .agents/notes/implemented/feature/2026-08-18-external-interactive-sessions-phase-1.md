...
`external/session-started` (including the opaque provider-thread identity), `external/turn-started`, `external/message-added`, `external/tool-activity`, `external/tool-call`, `external/tool-result`, `external/approval-asked`, `external/approval-decided`, `external/permission-asked`, `external/permission-decided`, `external/model-switched`, `external/compaction-noticed`, `external/turn-ended`, `external/session-ended`.
