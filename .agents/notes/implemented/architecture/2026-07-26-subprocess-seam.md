...
Every composition that loads a bash executor also loads `@knyazevai/dsh-subprocess-local` (CLI, examples, the Python bundled runtime, and inline test configs).
