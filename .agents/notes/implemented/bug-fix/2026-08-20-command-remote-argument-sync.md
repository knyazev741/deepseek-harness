...
The image-envelope decision remains owned by the [command package contract](../../../../packages/interaction/commands/README.md). This note records the cross-plane synchronization required when that shared method signature changes.
