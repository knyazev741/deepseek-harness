...
- The byte-for-byte prefix claim of the [prefix-cache-reuse decision](../../archived/bug-fix/2026-07-21-compaction-summary-prefix-cache-reuse.md) holds on the replayed span; only the span length changes.
