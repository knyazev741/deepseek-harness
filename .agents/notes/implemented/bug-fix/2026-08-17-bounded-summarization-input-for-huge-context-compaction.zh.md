...
- [前缀 cache 复用决策](../../archived/bug-fix/2026-07-21-compaction-summary-prefix-cache-reuse.md)的逐字前缀声明在所回放的 span 上仍然成立；变化的只是 span 长度。
