...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@knyazevai/dsh-agent-loop`.
- No cross-package deep imports (`@knyazevai/dsh-*/src/...` paths) — public entry points only.
