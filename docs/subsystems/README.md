...
| [agent-team.md](agent-team.md) | the experimental Agent Teams domain: implicit-root identity, durable peer mailbox, shared task DAG, and continuable-child lifecycle |
