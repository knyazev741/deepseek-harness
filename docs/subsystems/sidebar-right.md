...
| Field | Meaning |
|---|---|
| `id` | The implementation's identity, unique across every registration; a package name is the natural value (`@knyazevai/dsh-client-ui-sidebar-files`). It is the key the body and title register under. |
