...
import type { AgentContext } from '@knyazevai/dsh-client-runtime/client'
import type { Context } from '@deepseek-ai/cordis'
...
| Host | `@knyazevai/dsh-api-remotes` | Owns the application Agent/Session identity policy and configures the corresponding Typert lookups |
