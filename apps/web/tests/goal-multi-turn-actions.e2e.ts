...
import type {} from '@knyazevai/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@knyazevai/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@knyazevai/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@knyazevai/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@knyazevai/dsh-skill-filesystem"}\n',
