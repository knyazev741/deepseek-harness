...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@knyazevai/dsh-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
