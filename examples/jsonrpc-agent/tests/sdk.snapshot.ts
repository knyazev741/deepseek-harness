 ...
 * REAL `@knyazevai/dsh-sdk-client`, drives one turn over stdio JSON-RPC,
...
import { resolveExampleLaunch } from '@knyazevai/dsh-loader-smoke'
import { DeepSeekHarness, type HarnessNotification, type RunResult } from '@knyazevai/dsh-sdk-client'
