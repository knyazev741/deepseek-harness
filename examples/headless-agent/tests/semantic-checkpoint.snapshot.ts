...
import { normalizeSessionSnapshot, type NormalizeContext } from '@knyazevai/dsh-acp-snapshot'
...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId, type SessionEvent, type SessionHeader } from '@knyazevai/dsh-session'
