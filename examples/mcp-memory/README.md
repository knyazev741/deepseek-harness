...
These three **default-off reference configurations** connect one memory system to DSH through [`@knyazevai/dsh-mcp-client`](../../packages/mcp/mcp-client/README.md). Pick one, or copy the same generic MCP row for another server.
