...
function checkManifest(
  ...
  if (manifest.peerDependencies?.['@knyazevai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
  ...
  if (manifest.devDependencies?.['@knyazevai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@knyazevai/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@knyazevai/dsh-invariants'
