...
function validLayout(): NpmPackageLock {
  return {
    lockfileVersion: 3,
    packages: {
      '': { dependencies: { '@knyazevai/dsh': '0.2.0', 'dsh-previous': 'npm:@knyazevai/dsh@0.1.0' } },
      'node_modules/@deepseek-ai/cordis': { version: '4.0.1' },
      'node_modules/@knyazevai/dsh': {
        version: '0.2.0',
        dependencies: { '@knyazevai/dsh-child': '^0.2.0' },
        peerDependencies: { '@deepseek-ai/cordis': '^4.0.1' },
      },
      'node_modules/@knyazevai/dsh-child': {
        version: '0.2.0',
        dependencies: { '@knyazevai/dsh-leaf': '^0.2.0' },
      },
      'node_modules/@knyazevai/dsh-leaf': { version: '0.2.0' },
      'node_modules/dsh-previous': {
        name: '@knyazevai/dsh',
        version: '0.1.0',
        dependencies: { '@knyazevai/dsh-child': '^0.1.0' },
        peerDependencies: { '@deepseek-ai/cordis': '^4.0.1' },
      },
      'node_modules/dsh-previous/node_modules/@knyazevai/dsh-child': {
        version: '0.1.0',
        dependencies: { '@knyazevai/dsh-leaf': '^0.1.0' },
      },
      'node_modules/dsh-previous/node_modules/@knyazevai/dsh-leaf': { version: '0.1.0' },
    },
  }
}
...
describe('npm install layout verifier', () => {
  it('creates two incompatible versions of every DSH package', () => {
    const index: RegistryIndex = new Map([
      ['@knyazevai/dsh', new Map([['0.1.1-rc.2', {
        name: '@knyazevai/dsh',
        version: '0.1.1-rc.2',
        dependencies: { '@knyazevai/dsh-child': '^0.1.1-rc.2' },
        peerDependencies: { '@deepseek-ai/cordis': '^4.0.1' },
      }]])],
      ['@knyazevai/dsh-child', new Map([['0.1.1-rc.2', {
    ...
    expect([...dual.get('@knyazevai/dsh')?.keys() ?? []]).toEqual(['0.1.0', '0.2.0'])
    expect(dual.get('@knyazevai/dsh')?.get('0.1.0')).toMatchObject({
      version: '0.1.0',
      dependencies: { '@knyazevai/dsh-child': '^0.1.0' },
      peerDependencies: { '@deepseek-ai/cordis': '^4.0.1' },
    })
    expect(dual.get('@knyazevai/dsh')?.get('0.2.0')).toMatchObject({
      version: '0.2.0',
      dependencies: { '@knyazevai/dsh-child': '^0.2.0' },
    })
  ...
  it('rejects an internal edge that crosses release versions', () => {
    ...
    Reflect.deleteProperty(packages, 'node_modules/dsh-previous/node_modules/@knyazevai/dsh-leaf')

    expect(() => assertDualDshInstallLayout({ ...layout, packages })).toThrow(
      'node_modules/dsh-previous/node_modules/@knyazevai/dsh-child: dependencies '
      + '@knyazevai/dsh-leaf resolves to node_modules/@knyazevai/dsh-leaf@0.2.0, expected 0.1.0',
    )
  })
