...
import type { CordisCatalogModel, ServiceMethodEntry } from '@knyazevai/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@knyazevai/dsh-tool-cordis/api-catalog', '@knyazevai/dsh-cordis-client-runner/client/api-catalog')
