...
describe('DSH package rescope', () => {
  ...
  it('selects current tracked source and excludes historical or vendored records', () => {
    ...
    expect(eligibleDshRescopePath('.agents/notes/implemented/process/example.md')).toBe(true)
    expect(eligibleDshRescopePath('.agents/notes/archived/process/example.md')).toBe(false)
    ...
    expect(eligibleDshRescopePath('scripts/rescope-vendor.ts')).toBe(true)
    expect(eligibleDshRescopePath('scripts/rescope-vendor.spec.ts')).toBe(true)
