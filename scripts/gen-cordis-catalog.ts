...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ExternalToolPrincipal: 'tools.md',
  ExternalToolPrincipalId: 'tools.md',
  McpGatewayCreateRequest: 'tools.md',
  McpGatewayLease: 'tools.md',
  ToolExecutionIdentity: 'tools.md',
  ToolExecutionRecorder: 'tools.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExternalAgentDescriptor: 'external-session provider descriptor is owned by packages/external/external-session/README.md',
