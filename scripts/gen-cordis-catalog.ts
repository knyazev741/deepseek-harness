...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  uiRenderer: 'client-side renderer service — packages/client/ui-renderer/README.md owns the API',
  settingsSchema: 'client-side settings schema service — packages/client/ui-settings/README.md owns the API',
