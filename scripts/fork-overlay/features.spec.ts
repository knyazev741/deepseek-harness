...
describe('fork feature inventory schema', () => {
  it('loads the inventory with the exact closed feature id list and pre-merge dispositions', () => {
