...
const CHOOSER_PACKAGE = '@knyazevai/dsh-host-directory-picker-auto'
...
const CHOOSER_BACKEND_PACKAGES = [
  '@knyazevai/dsh-host-directory-picker-native',
  '@knyazevai/dsh-host-directory-picker-browse',
  '@knyazevai/dsh-client-ui-directory-picker-browse',
