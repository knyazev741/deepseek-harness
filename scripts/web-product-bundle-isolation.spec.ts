...
function fixture() {
  ...
  write('apps/web/package.json', '{"name":"@knyazevai/dsh-web-frontend","type":"module"}')
  ...
  write('packages/experimental/prototype/package.json', '{"name":"@knyazevai/dsh-experimental-prototype","type":"module"}')
...
describe('default Web bundle input isolation', () => {
  ...
  it('checks npm alias package identity independently of its directory name', async () => {
    ...
    test.write('apps/web/node_modules/ordinary-name/package.json',
      '{"name":"@knyazevai/dsh-experimental-aliased","type":"module","main":"index.js"}')
...
describe('bundler input ownership', () => {
  ...
  it('distinguishes missing actual inputs from omitted upstream source-map files', () => {
    ...
    test.write('apps/web/node_modules/upstream/package.json', '{"name":"@knyazevai/dsh-experimental-upstream"}')
    ownership.reset()
