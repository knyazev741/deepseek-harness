...
import type { ToolSchema } from '@knyazevai/dsh-llm'
...
import GoalService from '@knyazevai/dsh-goal'
import SystemPrompt from '@knyazevai/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@knyazevai/dsh-tools'
import LocalBashExecutor from '@knyazevai/dsh-bash-local'
import * as BashEnvPlugin from '@knyazevai/dsh-shell-env'
import { PwshLocalExecutor } from '@knyazevai/dsh-pwsh-local'
...
import PlanModeController from '@knyazevai/dsh-plan-mode'
import WebRuntime from '@knyazevai/dsh-web'
import * as WebSearchExa from '@knyazevai/dsh-web-search-exa'
import * as WebFetchLocal from '@knyazevai/dsh-web-fetch-http'
import SubagentRuntime from '@knyazevai/dsh-subagent'
import type { SubagentProvider } from '@knyazevai/dsh-subagent'
import * as ToolSubagentControl from '@knyazevai/dsh-tool-subagent-control'
import * as ToolSubagentListAgents from '@knyazevai/dsh-tool-subagent-control/list-agents'
...
import * as ToolAskUser from '@knyazevai/dsh-tool-ask-user'
import * as ToolBash from '@knyazevai/dsh-tool-bash'
import * as ToolPwsh from '@knyazevai/dsh-tool-pwsh'
import * as ToolBashPersistent from '@knyazevai/dsh-tool-bash-persistent'
import * as ToolPwshPersistent from '@knyazevai/dsh-tool-pwsh-persistent'
import CordisHostRunner from '@knyazevai/dsh-cordis-host-runner'
import * as ToolCordis from '@knyazevai/dsh-tool-cordis'
import * as ToolPresent from '@knyazevai/dsh-tool-present'
import * as ToolFs from '@knyazevai/dsh-tool-fs'
import * as ToolFsSearch from '@knyazevai/dsh-tool-fs-search'
import * as ToolStrReplaceEditor from '@knyazevai/dsh-tool-str-replace-editor'
...
import * as ToolSchedule from '@knyazevai/dsh-schedule'
import Lsp from '@knyazevai/dsh-lsp'
import * as ToolLsp from '@knyazevai/dsh-tool-lsp'
...
import * as StagehandBrowserTools from '@knyazevai/dsh-experimental-browser-use-stagehand-native'
import type TeamService from '@knyazevai/dsh-experimental-agent-team'
import * as ToolTeam from '@knyazevai/dsh-experimental-tool-agent-team'
import * as ToolTodo from '@knyazevai/dsh-tool-todo'
import McpResources from '@knyazevai/dsh-mcp-resources'
import * as ToolSubagent from '@knyazevai/dsh-tool-subagent'
import { registerListSubagentModels } from '../packages/subagent/tool-subagent/src/list-models.ts'
import * as ToolWeb from '@knyazevai/dsh-tool-web'
import WorkflowEngine from '@knyazevai/dsh-workflow'
import type { WorkflowRun, WorkflowStartRequest } from '@knyazevai/dsh-workflow'
import * as ToolRalph from '@knyazevai/dsh-tool-ralph'
import * as ToolWorkflow from '@knyazevai/dsh-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@knyazevai/dsh-mcp-resources',
    dir: 'mcp-resources',
  ...
  {
    pkg: '@knyazevai/dsh-experimental-browser-use-stagehand-native',
  ...
  {
    pkg: '@knyazevai/dsh-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  },
  {
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. A `run_in_background` run registers with the generic `ctx.jobs` runtime and is collected/stopped through the `job_*` tools from `@knyazevai/dsh-tool-jobs`; the `enableRunInBackground` config (default true) removes the parameter entirely when disabled.',
  },
  {
    pkg: '@knyazevai/dsh-tool-present',
    dir: 'tool-present',
  ...
  },
  {
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@knyazevai/dsh-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `DSH_*` environment comes from `@knyazevai/dsh-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@knyazevai/dsh-tool-cordis',
    dir: 'tool-cordis',
    ...
    note:
      'Not in any shipped tree (a deliberate opt-in — dynamic package code reaches the real runtime, see .agents/notes/implemented/feature/2026-07-08-self-referential-cordis-toolset.md). The toolset injects `ctx.dynamicCordisRunner` from `@knyazevai/dsh-cordis-host-runner`, which owns the definition registry and the vm sandbox; a composition missing it never activates the tools. A running package may register ADDITIONAL model-visible tools until it is stopped, undefined, or DSH restarts; a full changed request header logs those tool-set changes.',
  },
  {
    pkg: '@knyazevai/dsh-tool-bash-persistent',
  ...
  {
    pkg: '@knyazevai/dsh-tool-pwsh-persistent',
  ...
  {
    pkg: '@knyazevai/dsh-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@knyazevai/dsh-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. The image tool is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@knyazevai/dsh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@knyazevai/dsh-tool-terminal',
    dir: 'tool-terminal',
  ...
  },
  {
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@knyazevai/dsh-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@knyazevai/dsh-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@knyazevai/dsh-tool-session-query',
  ...
  {
    pkg: '@knyazevai/dsh-tool-subagent',
    dir: 'tool-subagent',
    source: {
  ...
  {
    pkg: '@knyazevai/dsh-tool-subagent-control',
  ...
  {
    pkg: '@knyazevai/dsh-experimental-tool-agent-team',
    dir: 'tool-agent-team',
  ...
  {
    pkg: '@knyazevai/dsh-tool-workflow',
    dir: 'tool-workflow',
