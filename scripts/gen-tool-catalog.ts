...
import type { SubagentProvider, SubagentReportDelivery } from '@knyazevai/dsh-subagent'
...
import * as ToolSubagentReport from '@knyazevai/dsh-tool-subagent-report'
...
import * as ToolTasks from '@knyazevai/dsh-tool-jobs'
...
import VmWorkflowEngine from '@knyazevai/dsh-workflow-worker-thread'
...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  },
  {
    ...
    requires: ['ctx.tools', 'ctx.subagents', 'ctx.systemPrompt', 'ctx.llm'],
  ...
  {
    pkg: '@knyazevai/dsh-tool-subagent-report',
